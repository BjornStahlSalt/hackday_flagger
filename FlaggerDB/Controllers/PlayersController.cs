...
//   public async Task<IActionResult> Create([Bind("Id,Name,Wins,GamesPlayed")] Player player)
//   {
...
//   [HttpPost]
//   [ValidateAntiForgeryToken]
//   public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Wins,GamesPlayed")] Player player)
//   {
//     if (id != player.Id)
//     {
//       return NotFound();
